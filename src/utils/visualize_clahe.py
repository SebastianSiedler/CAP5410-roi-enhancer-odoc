...
def main():
    ...
    parser = argparse.ArgumentParser(description='Visualize CLAHE effect')
    parser.add_argument('--root-dir', type=str, default='.',
                        help='Project root directory')
    parser.add_argument('--num-samples', type=int, default=4,
                        help='Number of samples to visualize')
    parser.add_argument('--save-path', type=str, default='results/clahe_comparison.png',
                        help='Path to save visualization')
    parser.add_argument('--seed', type=int, default=42,
                        help='Random seed')
    parser.add_argument('--clip-limit', type=float, default=2.0,
                        help='CLAHE clip limit')
    parser.add_argument('--tile-grid-size', type=int, nargs=2, default=[8, 8],
                        help='CLAHE tile grid size (e.g., 8 8)')
