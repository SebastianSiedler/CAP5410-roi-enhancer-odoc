"""
Test script for EE-TransUNet model (Experiment 06)
Loads checkpoint, evaluates on test set, creates visualizations and metrics

Usage from experiment folder:
    python test_visualizations.py --checkpoint results/checkpoint_epoch_39.pth
"""
...
def get_args():
    ...
    parser.add_argument('--checkpoint', type=str,
                       default='results/checkpoint_epoch_39.pth',
